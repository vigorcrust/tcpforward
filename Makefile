...
tar = cd build && tar -cvzf $(appname)_$(1)_$(2).tar.gz $(appname)$(3) README.md LICENSE && rm $(appname)$(3)
zip = cd build && zip $(appname)_$(1)_$(2).zip $(appname)$(3) README.md LICENSE && rm $(appname)$(3)
